...
public class PlaceStructure extends jbt.model.task.leaf.action.ModelAction {
	...
	/**
	 * Returns a java.jbt.bts.actions.execution.PlaceStructure task that is able
	 * to run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new java.jbt.bts.actions.execution.PlaceStructure(this,
